      ...
      <section className="py-20 bg-gradient-to-r from-primary to-accent text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto">
            Discover Premium Solar Solutions Built for Nigeria. Explore our expertly crafted solar systems—designed to power your home or business reliably, efficiently, and affordably.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredAndSortedProducts.map((product) => (
              <Card key={product.id} className={`hover:shadow-xl transition-all duration-300 ${product.highlight ? 'border-primary border-2 relative' : ''}`}>
                {product.highlight && (
