...
const SolarEducationSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: 'We offer full end-to-end support—including installation, system monitoring, and ongoing maintenance. Every system is backed by a comprehensive warranty, and our local technicians are available for on-site support when needed. You are not just buying a product, you are gaining a long-term energy partner.'
    },
    {
